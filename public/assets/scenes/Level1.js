...
export default class Level1 extends Phaser.Scene {
  ...
  crearExplosion(x, y) {
    ...
    this.explosion.on("animationcomplete", () => {}, this);
  ...
  gameOver() {
    ...
    this.botonInt = this.add
      .image(265, 400, "botonInt")
      .setInteractive()
      .on("pointerdown", () => this.scene.start("Menu"));
    this.reset = this.add
      .image(555, 400, "reset")
  ...
  win() {
    ...
    this.mejoras = this.add
      .image(400, 420, "updates")
      .setScale(0.25)
      .setInteractive()
    ...
    this.pointsText = this.add.text(
      200,
      270,
      "Puntos conseguidos:" + this.score1,
      {
        fontSize: "24px",
        fontStyle: "bold",
        frontFamily: "Console",
    ...
    this.cantAText = this.add.text(
      200,
      320,
      "Asteroides destruidos:" + this.cantAsteroides1,
      {
        fontSize: "24px",
        fontStyle: "bold",
        frontFamily: "Console",
  ...
  updates() {
    ...
    //mejoras
    this.update1Esc = this.add
      .image(230, 270, "update1Esc")
      .setScale(0.5)
      .setInteractive()
      .setDepth(4)
    ...
    this.update2Vel = this.add
      .image(400, 270, "update2Vel")
      .setScale(0.5)
      .setInteractive()
      .setDepth(4)
    ...
    this.update3Dur = this.add
      .image(570, 270, "update3Dur")
      .setScale(0.5)
      .setInteractive()
      .setDepth(4)
  ...
  shootMisile() {
    ...
    if (this.cantMisil > 0 && this.load === true) {
      ...
      .image(400, 580, "misile")
      .setScale(1)
      .setCircle(4, 0.5, 0.5)
      setTimeout(() => misil.destroy(), 2000);

    this.misileGroup.add(misil);

    // obtener el asteroid mas cercano o dar la posicion 0,0 al misil

    const asteroid = this.asteroidGroup.getChildren()[0] || { x: 0, y: 0 };

      console.log("move to " + asteroid.x + " " + asteroid.y)

      this.physics.moveTo(misil, asteroid.x, asteroid.y, 700);

      // rotate missile to face asteroid
      const angle = Phaser.Math.Angle.BetweenPoints(asteroid, misil) - Math.PI / 2;
      misil.setRotation(angle);
